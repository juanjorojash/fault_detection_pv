/*
 * Program for controlling EPS prototype of FRDET architecture with MPPT
 * =====================================================================
 * plus lots of gimmicks and fun!
 *
...
static char typeString[] = "MSP432P401R LaunchPad on EPS prototype: FRDET with MPPT\n";
...
//    ADC14_setSampleHoldTime(ADC_PULSE_WIDTH_128, ADC_PULSE_WIDTH_128);
    ...
    while (1) {
        ...
        case WRITE_DUTYCYCLE:
            spi_routines();             // OUTPUT:  write commands via SPI to BDC ï¿½Cs
